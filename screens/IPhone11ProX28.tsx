...
const IPhone11ProX28 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone11ProX28}>
      <View
        style={[styles.iphone11ProX28Child, styles.rectangleParentPosition]}
      />
      ...
      <Image
        style={[styles.iphone11ProX28Item, styles.iphone11Layout]}
        contentFit="cover"
        source={require("../assets/group-59.png")}
      />
      <Image
        style={[styles.iphone11ProX28Inner, styles.iphone11Layout]}
        contentFit="cover"
      ...
      <FormSection />
      <View style={[styles.iphone11ProX28Child1, styles.childPosition]} />
      <Text style={[styles.keranjang1, styles.keranjangTypo]}>Keranjang</Text>
      <Pressable
        style={[styles.iphone11ProX28Inner, styles.iphone11Layout]}
        onPress={() => navigation.navigate("IPhone11ProX26")}
      >
        <Image
          style={styles.icon}
          contentFit="cover"
      ...
      <View
        style={[styles.iphone11ProX28Child2, styles.iphone11ChildPosition]}
      />
      ...
      />
      <View
        style={[styles.iphone11ProX28Child4, styles.iphone11ChildPosition]}
      />
      <Text style={[styles.totalPesanan, styles.rp150kTypo]}>
        Total Pembayaran
      </Text>
