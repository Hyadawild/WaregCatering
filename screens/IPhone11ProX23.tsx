...
const IPhone11ProX23 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone11ProX23}>
      <View style={[styles.iphone11ProX23Child, styles.iphone11Position1]} />
      <Text style={styles.nomorMeja}>Nomor Meja</Text>
      <View style={[styles.iphone11ProX23Item, styles.iphone11Position1]} />
      <Text style={styles.keranjang}>Keranjang</Text>
      <View style={[styles.iphone11ProX23Inner, styles.iphone11Position]} />
      ...
      />
      <Image
        style={[styles.iphone11ProX23Child1, styles.groupIconLayout]}
        contentFit="cover"
        source={require("../assets/group-60.png")}
      />
      <View style={[styles.iphone11ProX23Child2, styles.groupChildLayout]} />
      <View style={[styles.iphone11ProX23Child2, styles.groupChildLayout]} />
      <Pressable
        style={[styles.iphone11ProX23Child2, styles.groupChildLayout]}
        onPress={() => navigation.navigate("IPhone11ProX27")}
      />
      <View style={[styles.iphone11ProX23Child4, styles.iphone11Position]} />
      <Text style={[styles.totalPesanan, styles.itemTypo]}>
        Total Pembayaran
      </Text>
      <Text style={styles.jumlahItem}>Jumlah</Text>
      <Text style={[styles.rp375000, styles.item1Typo]}>Rp. 375.000</Text>
      ...
      <SectionCardFormFilter
        packageDescription="Paket Bulanan Hemat"
...
const styles = StyleSheet.create({
  ...
  iphone11ProX23Child1: {
    left: 13,
    top: 15,
  },
  iphone11ProX23Child2: {
    backgroundColor: Color.colorWhite,
    height: 39,
    top: 155,
  },
  iphone11ProX23Child4: {
